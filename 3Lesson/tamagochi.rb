...
class Pet
 ...
 def passageOfTime
  ...
  if @feed_pt <= 0
    ...
    content = "<div>**Status of eat: #{@feed_pt} &#127828;</div> 
               <div>**Status of toilet: #{@walk} &#x1F6BD;</div> 
               <div>**Status of submission: #{@discipline_pt} &#128525;</div> 
               <div>**Status of happy: #{@happiness_pt} &#128522;</div> 
               <div>**Pet lifes : #{@health_pt} &#128567;</div> "

  bypass_html = true

  @file = Create_Html.new
  name_fl = @name
  @file.my_method( content, bypass_html, name_fl)
